...
class TestErrorResponses:
    ...
    def test_error_response_structure(self):
        ...
        response = client.get(f"{API_PREFIX}/memories/00000000-0000-0000-0000-000000000000")
    ...
    def test_request_id_in_headers(self):
        ...
        response = client.get(f"{API_PREFIX}/memories/non-existent-id")
...
class TestValidationHandlerUnit:
    """Unit tests for structured FastAPI validation responses."""

    def test_request_validation_error_handler_returns_structured_422(self):
        request = Request({
            "type": "http",
            "method": "POST",
            "path": f"{API_PREFIX}/memories",
            "headers": [],
        })
        exc = RequestValidationError(
            [{"type": "missing", "loc": ("body", "memory_type"), "msg": "Field required", "input": {}}]
        )
        ...
        assert '"error":"ValidationError"' in payload
        assert '"code":"VALIDATION_FAILED"' in payload
